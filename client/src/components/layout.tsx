          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2">
              <div className="dark:bg-white dark:p-1 dark:rounded-lg dark:shadow-[0_0_10px_rgba(255,255,255,0.2)]">
                <img src="/images/logo.webp" alt="PromptFix - AI Prompt Fixer and Prompt Engineering Tool Logo" className="h-12 w-auto object-contain" width="48" height="48" loading="eager" />
              </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 pb-6">
            <div className="flex items-center gap-2">
              <div className="dark:bg-white dark:p-0.5 dark:rounded-md dark:shadow-[0_0_10px_rgba(255,255,255,0.2)]">
                <img src="/images/logo.webp" alt="Get Prompt Fix - AI Prompt Fixer Tool" className="h-6 w-auto grayscale opacity-50" width="24" height="24" loading="lazy" />
              </div>
