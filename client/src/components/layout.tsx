        ...
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2">
              <img src="/images/logo.webp" alt="PromptFix - AI Prompt Fixer and Prompt Engineering Tool Logo" className="h-12 w-auto object-contain dark:drop-shadow-[0_0_5px_rgba(255,255,255,0.5)] dark:bg-white/10 dark:rounded-md dark:p-1" width="48" height="48" loading="eager" />
      ...
      <footer className="bg-muted/30">
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 pb-6">
            <div className="flex items-center gap-2">
              <img src="/images/logo.webp" alt="Get Prompt Fix - AI Prompt Fixer Tool" className="h-6 w-auto grayscale opacity-50 dark:drop-shadow-[0_0_5px_rgba(255,255,255,0.5)] dark:bg-white/10 dark:rounded-md dark:p-0.5" width="24" height="24" loading="lazy" />
